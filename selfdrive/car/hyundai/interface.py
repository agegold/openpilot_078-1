...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):  # pylint: disable=dangerous-default-value
    ...
    if candidate == CAR.GRANDEUR_HEV_19:
      ...
      ret.atomTuning.cvV  = [[180., 220., 255.], [180., 220., 255.], [180., 220., 255.] ]  # CV
      ret.atomTuning.cvSteerMaxV = [[255,255,200] ,[255,255,200] ,[255,255,200]]
      ret.atomTuning.cvSteerdUpV = [[3,3,3],[3,3,3],[3,3,3]]
      ret.atomTuning.cvSteerdDnV = [[7,7,7],[7,7,5],[7,7,5]]

      ret.atomTuning.srV        = [ [-10,    0.,     10],     [-10.,    0.,     10.],    [-10.,   0.,     10.]    ]  # CV
      ret.atomTuning.srkiV      = [ [0.02,   0.01,   0.02],   [0.02,    0.01,   0.02],   [0.02,   0.01,   0.02]   ]
      ret.atomTuning.srscaleV   = [ [1900.0, 2100.0, 1900.0], [1800.0,  2000.0, 1800.0], [1700.0, 1900.0, 1700.0] ]
